...
import edu.brown.cs.jc124.autocorrect.rank.BasicRanker;
...
public final class AutoCorrector {
  ...
  public static class Builder {
     ...
     *           if no suggestors were given to the builder
     * @throws NullPointerException
     *           if a ranker wasn't given to the builder
     */
    ...
    /**
     * Helper for setting the ranker to a basic ranker.
     *
     * @param bigram
     *          the bigram frequency map to use for ranking
     * @param unigram
     *          the unigram frequency map to use for ranking
     * @return the current Builder object, for chaining commands
     */
    public Builder setBasicRanker(NgramFrequency bigram,
        NgramFrequency unigram) {
      return setRanker(new BasicRanker(bigram, unigram));
    }
     ...
     * @return the current Builder object, for chaining commands
     */
    public Builder setSmartRanker(NgramFrequency bigram,
        NgramFrequency unigram) {
      return setRanker(new SmartRanker(bigram, unigram));
    }
  }
