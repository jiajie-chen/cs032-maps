...
public interface Coordinate {
   ...
   *
   * @param axis
   *          the axis of the field, zero-indexed
   * @return the field at that axis
   * @throws IllegalArgumentException
   *           if the axis is negative
   * @throws IndexOutOfBoundsException
   *           if the axis exceeds the dimensionality of the coordinate
   */
  public double getField(int axis);

  /**
   * Gets the squared distance for this coordinate to another Used by KdTree for
   * efficiency.
   *
   * @param c
   *          the coordinate to measure distance to
   * @return the squared distance of the coordinate from c
   * @throws DimensionMismatchException
   *           if the given coordinate doesn't match dimensionality with the
   *           given coordinate
   */
